...
public class DBSPopulater {
    ...
    public static void populateBD() {
        ...
        Log.d("Médico João", mDb.getMedicoByEspecialidade("Pneumologista").get(0).getNome());
        Log.d("Médico José", mDb.getMedicoByEspecialidade("Pneumologista").get(0).getNome());
        Log.d("Médico Douglas", mDb.getMedicoByEspecialidade("Pneumologista").get(0).getNome());
